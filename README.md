...
Edit in `index.html` (title and description are auto-updated from data):
...
2. **Minimize HTTP requests** (all CSS/JS is consolidated)
3. **Use CDN for fonts** (already configured)
4. **Enable caching** (automatic on GitHub Pages)

## ⚡ Features

- ✅ **Template-based architecture** - Easy content management
...
1. **Keep data organized** - Use clear, descriptive names in your data objects
2. **Update regularly** - Keep your projects and skills current
3. **Use high-quality images** - First impressions matter
4. **Write clear descriptions** - Make your work easy to understand
5. **Test on mobile** - Most visitors will view on phones
6. **Keep it simple** - Don't overcomplicate the content
7. **Use version control** - Commit changes regularly with clear messages

## 🆘 Troubleshooting

### Content Not Showing
- Check browser console for JavaScript errors (F12)
- Verify `data/portfolio-data.js` syntax is correct
- Ensure all script tags are in correct order in `index.html`
...
### Styling Issues
- Check if custom CSS conflicts with existing styles
- Verify CSS custom properties are properly defined
- Test in browser dev tools (F12 → Elements)

### Dark Mode Issues
- Check if theme toggle button is working
- Verify dark mode styles are defined in CSS
